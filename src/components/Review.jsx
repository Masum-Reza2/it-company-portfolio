            ...
            <section className='mt-2'>
                <div className='lg:grid lg:grid-cols-3 lg:place-items-center'>
                    <div className='p-3 space-y-3  lg:w-3/4 lg:h-full'>
                        ...
                        <details className='border-y border-sky-500'>
                            <summary className='font-bold'>Business Modeling</summary>
                    ...
                    <div className='p-3 space-y-3  lg:w-3/4 lg:h-full'>
                        ...
                        <details className='border-y border-sky-500'>
                            <summary className='font-bold'>Web and App developmen</summary>
                            <ul className='p-5 list-disc text-sm font-semibold space-y-2'>
                                <li>Workshops</li>
                                <li>User journeys</li>
                                <li>Wireframing</li>
                        ...
                        <details className='border-y border-sky-500'>
                            <summary className='font-bold'>Change Management</summary>
                            <ul className='p-5 list-disc text-sm font-semibold space-y-2'>
                    ...
                    <div className='p-3 space-y-3  lg:w-3/4 lg:h-full'>
                        ...
                        <details className='border-y border-sky-500'>
                            <summary className='font-bold'>Definition</summary>
                            <ul className='p-5 list-disc text-sm font-semibold space-y-2'>
                        ...
                        <details className='border-y border-sky-500'>
                            <summary className='font-bold'>Design</summary>
                            <ul className='p-5 list-disc text-sm font-semibold space-y-2'>
                                <li>Product Training</li>
                                <li>Documentation</li>
                                <li>Communication</li>
                        ...
                        <details className='border-y border-sky-500'>
                            <summary className='font-bold'>Growth Hacking</summary>
                            <ul className='p-5 list-disc text-sm font-semibold space-y-2'>
